...
- **Deleting** is instant, with a six-second Undo. Undo works by not having told the server yet; switching tab or leaving inside the window still deletes.

...
export function ConfirmDialog({ ref, title, children, confirmLabel, danger, onConfirm }: ConfirmDialogProps) {
  ...
  return (
    <dialog ref={dialog} onClose={() => setError(null)} className="m-auto w-[min(26rem,calc(100vw-2rem))] rounded-2xl border border-slate-200 p-0 shadow-xl backdrop:bg-black/50 backdrop:backdrop-blur-sm">
